...
const handleAddTtsProvider = (provider: {
  name: string; apiKey: string; model: string; speedFactor: number; voice:
  string
}) => {
    ...
    <fieldset>
      ...
      <section class="settings-section">
        ...
        <div class="form-group">
          <label for="batchWindowDuration" class="form-label">{{ $t('settings_batch_window_duration') }}</label>
          <input id="batchWindowDuration" v-model.number="localSettings.batchWindowDuration" type="number" min="1"
            class="form-input" aria-describedby="batchWindowDuration-desc" />
    ...
    <fieldset>
      ...
      <section class="settings-section">
        ...
        <div class="provider-controls">
          <button type="button" @click="openVisionProviderModal" class="btn btn-primary" aria-haspopup="dialog">
        ...
        <div class="form-group">
          ...
          <select id="visionProvider" v-model="localSettings.visionProvider" class="form-select"
            ...
            <option v-for="provider in visionProvidersArray" :key="provider.name" :value="provider.name">
              {{ provider.name }}
            </option>
          </select>
        ...
        <table class="providers-table" v-if="visionProvidersArray.length > 0">
          ...
          <tbody>
            <tr v-for="provider in visionProvidersArray" :key="provider.name">
              ...
              <td>
                <button type="button" @click="removeVisionProvider(provider.name)" class="btn btn-danger btn-sm"
      ...
      <section class="settings-section">
        ...
        <div class="provider-controls">
          <button type="button" @click="openTtsProviderModal" class="btn btn-primary" aria-haspopup="dialog">
        ...
        <table class="providers-table" v-if="ttsProvidersArray.length > 0">
          ...
          <tbody>
            <tr v-for="provider in ttsProvidersArray" :key="provider.name">
              ...
              <td>{{ provider.apiKey }}</td>
              <td>
                <button type="button" @click="removeTtsProvider(provider.name)" class="btn btn-danger btn-sm"
